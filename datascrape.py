...
class App:
    def __init__(self, username='ravalivishnubhotla', password='ravali@1995', target_username='ravalivishnubhotla',
                 path='/Users/admin/Desktop/instaPhotos'): #Change this to your Instagram details and desired images path
        self.username = username
        self.password = password
        self.target_username = target_username
        self.path = path
        self.driver = webdriver.Chrome() #Change this to your ChromeDriver path.I have my chrome driver in the same path
        self.error = False
